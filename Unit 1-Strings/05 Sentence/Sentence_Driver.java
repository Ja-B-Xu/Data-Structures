...
public class Sentence_Driver
{
   public static void main(String[] args)
   {
      ...
      s = new Sentence( "Sore was I ere I saw Eros." );
      System.out.println( s.getSentence() );
      System.out.println( s.getNumWords() );
      System.out.println( s.isPalindrome() );
      System.out.println();
      
      s = new Sentence( "Stop! nine myriad murmur. Put up rum, rum, dairymen, in pots." );
      System.out.println( s.getSentence() );
      System.out.println( s.getNumWords() );
      System.out.println( s.isPalindrome() );
      System.out.println();
      
      s = new Sentence( "Sirrah! Deliver deified desserts detartrated! stressed deified, reviled Harris." );
      System.out.println( s.getSentence() );
      System.out.println( s.getNumWords() );
      System.out.println( s.isPalindrome() );
      System.out.println();
...
class Sentence
{
   ...
   {
      String sent1=removeBlanks(mySentence);
      String sent2=lowerCase(sent1);
      String sent3=removePunctuation(sent2);
      boolean tf=isPalindrome(sent3,0,sent3.length()-1);
      return tf;
   }
