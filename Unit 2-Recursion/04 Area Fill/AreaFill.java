...
public class AreaFill
{
   ...
   public static char[][] read(String filename)
   {
      ...
      char[][] n=new char[infile.nextInt()][infile.nextInt()];
   ...
   public static int fillAndCount(char[][] g, int r, int c, char ch)
   {
      ...
      g[r][c]='*';
      int a1=fillAndCount(g,r+1,c,ch);
      int a2=fillAndCount(g,r-1,c,ch);
      int a3=fillAndCount(g,r,c+1,ch);
      int a4=fillAndCount(g,r,c-1,ch);
